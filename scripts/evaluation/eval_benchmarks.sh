...
QWEN35_ENV_ROOT="${QWEN35_ENV_ROOT:-$HOME/.conda/envs/adageovln-qwen35}"
...
export TRITON_CACHE_DIR="${TRITON_CACHE_DIR:-${TMPDIR:-/tmp/$USER}/adageovln-triton/${SLURM_JOB_ID:-manual}/${SLURM_PROCID:-0}}"
